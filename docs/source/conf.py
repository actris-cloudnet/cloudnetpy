...
latex_documents = [
    (master_doc, 'cloudnet.tex', 'cloudnet Documentation',
     'Finnish Meteorological Institute', 'manual'),
]
...
man_pages = [
    (master_doc, 'cloudnet', 'cloudnet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cloudnet', 'cloudnet Documentation',
     author, 'cloudnet', 'One line description of project.',
     'Miscellaneous'),
]
