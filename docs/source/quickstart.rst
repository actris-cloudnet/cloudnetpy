...
Level 1b products are generated from raw data from measurement instruments.
...
Alternatively, you can download `preprocessed example products <http://lake.fmi.fi/cloudnet-public/cloudnetpy_test_input_files.zip>`_
and jump to the next section on higher level products.
...
a model file, higher level Cloudnet products can be created.
...
included in the provided `example files <http://devcloudnet.fmi.fi/files/cloudnetpy_test_input_files.zip>`_.
