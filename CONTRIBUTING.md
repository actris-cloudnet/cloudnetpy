...
If you have a good idea of how to improve the code without changing the actual outcome
of the processing, you can directly create a [pull request](https://github.com/actris-cloudnet/cloudnetpy/pulls) (PR).
Examples of these kinds of changes are better
...
reviewed and tested before accepting. Examples include modifications in the
