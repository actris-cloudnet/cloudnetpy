...
def generate_epsilon_from_radar(
    ...
    References:
        ...
        cruise PS106. Atmos. Meas. Tech., 13(10), 5335-5358.
        https://doi.org/10.5194/amt-13-5335-2020

        Borque, P., Luke E., & Kollias P. (2016). On the unified estimation of
        turbulence eddy dissipation rate using Doppler cloud radars and lidars.
        JGR Atmospheres, 121(10), 5972-5989. https://doi.org/10.1002/2015JD024543
